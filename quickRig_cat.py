...
class Cat:
    def __init__(self):
        ...
        self.jntPosition = {
            ...
            "LeftFrontLeg_BL": (16.83342, 57.23504, 54.6412), 
            "LeftFrontLeg_BR": (8.24673, 57.23504, 54.6412), 
            "RightFrontLeg_A": (-12.652, 77.0509, 60.997), 
            "RightFrontLeg_B": (-12.652, 57.235, 54.6412), 
            ...
            "LeftFrontKnee_BL": (16.86979, 47.54553, 51.5506), 
            "LeftFrontKnee_BR": (9.90927, 47.54551, 51.55061), 
            "RightFrontKnee_A": (-12.652, 25.4666, 48.4781), 
            "RightFrontKnee_B": (-12.652, 47.5455, 51.5506), 
            ...
            "LeftBackKnee_BL": (14.13582, 49.79593, -67.95204), 
            "LeftBackKnee_BR": (7.12108, 49.79647, -67.9521), 
            "RightBackKnee_A": (-11.0419, 33.1226, -77.5214), 
            "RightBackKnee_B": (-11.0431, 49.7962, -67.9521), 
            "RightBackKnee_BC": (-11.0433, 53.2123, -71.5493), 
            "RightBackKnee_BL": (-14.1358, 49.7959, -67.952), 
            "RightBackKnee_BR": (-7.12108, 49.7965, -67.9521), 
            }
        self.jntHierarchy = {
