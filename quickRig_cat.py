...
class Cat:
    def __init__(self):
        self.spine = [f"Spine{i}" for i in range(1, 12)]
        self.legs_LB = [
            'LeftBackLeg', 
            'LeftBackKnee', 
            'LeftBackAnkle', 
        ...
        self.jntPosition = {
            ...
            'Spine1': (-0.0, 105.51868, -47.21707), 
            'Spine2': (-0.0, 104.7666, -37.87569), 
            'Spine3': (-0.0, 104.06595, -28.53123), 
            'Spine4': (-0.0, 104.8734, -19.20602), 
            'Spine5': (-0.0, 105.64769, -9.87381), 
            'Spine6': (-0.0, 105.03153, -0.52718), 
            'Spine7': (-0.0, 103.36463, 8.69068), 
            'Spine8': (-0.0, 101.52061, 17.87711), 
            'Spine9': (-0.0, 100.51674, 27.19076), 
            'Spine10': (-0.0, 100.31027, 36.55808), 
            'Spine11': (-0.0, 101.12589, 45.88787), 
