...
if pm.window(winName, exists=True):
    ...
    pm.button(l='colors_blue', c=lambda x: hjk.colors(blue=True))
    pm.button(l='colors_blue2', c=lambda x: hjk.colors(blue2=True))
    pm.button(l='colors_pink', c=lambda x: hjk.colors(pink=True))
    pm.button(l='colors_red', c=lambda x: hjk.colors(red=True))
    pm.button(l='colors_red2', c=lambda x: hjk.colors(red2=True))
    pm.button(l='colors_green', c=lambda x: hjk.colors(green=True))
    pm.button(l='colors_green2', c=lambda x: hjk.colors(green2=True))
    pm.button(l='colors_yellow', c=lambda x: hjk.colors(yellow=True))
