...
class Car(QWidget):
    ...
    def setupUI(self):
        ...
        self.gridLayout_wheelGroup = QGridLayout()
        self.verticalLayout_wheel.addLayout(self.gridLayout_wheelGroup)
    ...
    def buttonsLink(self):
        ...
        self.btnCreateWheel.clicked.connect(self.build_wheel)
    ...
    def build_wheel(self):
        ...
        self.createWheelRotationLocator(ctrlName)

        
    def selectWheelGroup(self):
        for idx, grp in enumerate(self.wheelGroup):
            row, column = divmod(idx, 2)
            fld = QLineEdit(grp, self)
            self.gridLayout_wheelGroup.addWidget(fld, row, column, 1, 1)
    ...
    def selectObjectGroup(self):
        ...
        if not sel:
            ...
            grp = sel[0]
            self.objGroup = grp
            self.lineSelObj.setText(grp.name())
            return grp
    ...
    def selectBodyGroup(self):
        ...
        if not sel:
            ...
            grp = sel[0]
            self.bodyGroup = grp
            self.lineSelBody.setText(grp.name())
            return grp
    ...
    def createTopGroup(self) -> str:
        ...
        if self.topGroup == "" and txt == "":
            pm.warning("Group name field is empty.")
            return
